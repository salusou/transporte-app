...
import { PositionsUpdatePortalComponent } from './positions-update.component';

describe('Component Tests', () => {
  describe('Positions Management Update Component', () => {
    let comp: PositionsUpdatePortalComponent;
    let fixture: ComponentFixture<PositionsUpdatePortalComponent>;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [PositionsUpdatePortalComponent],
        providers: [FormBuilder, ActivatedRoute],
      })
        .overrideTemplate(PositionsUpdatePortalComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(PositionsUpdatePortalComponent);
