...
describe('Component Tests', () => {
  describe('CustomerAttachments Management Component', () => {
    let comp: CustomerAttachmentsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CustomerAttachmentsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.customerAttachments?.[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
