...
export class VehicleControlsComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.vehicleControlsService
      ...
      .subscribe(
        (res: HttpResponse<IVehicleControls[]>) => {
  ...
  trackId(index: number, item: IVehicleControls): number {
    return item.id!;
  }

  delete(vehicleControls: IVehicleControls): void {
    const modalRef = this.modalService.open(VehicleControlsDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.vehicleControls = vehicleControls;
  ...
  protected onSuccess(data: IVehicleControls[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
