...
describe('Component Tests', () => {
  describe('VehicleControls Management Component', () => {
    let comp: VehicleControlsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(VehicleControlsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.vehicleControls?.[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
