...
export class StateProvincesComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.stateProvincesService
      ...
      .subscribe(
        (res: HttpResponse<IStateProvinces[]>) => {
  ...
  protected onSuccess(data: IStateProvinces[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
