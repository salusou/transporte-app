...
import { ServiceProvidedUpdateComponent } from './service-provided-update.component';

describe('Component Tests', () => {
  describe('ServiceProvided Management Update Component', () => {
    let comp: ServiceProvidedUpdateComponent;
    let fixture: ComponentFixture<ServiceProvidedUpdateComponent>;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [ServiceProvidedUpdateComponent],
        providers: [FormBuilder, ActivatedRoute],
      })
        .overrideTemplate(ServiceProvidedUpdateComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(ServiceProvidedUpdateComponent);
