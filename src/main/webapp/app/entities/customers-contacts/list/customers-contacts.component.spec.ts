...
describe('Component Tests', () => {
  describe('CustomersContacts Management Component', () => {
    let comp: CustomersContactsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CustomersContactsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.customersContacts?.[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
