...
describe('Component Tests', () => {
  describe('Housing Management Component', () => {
    let comp: HousingComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(HousingComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.housings?.[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
