...
import { StatusAttachmentsUpdateComponent } from './status-attachments-update.component';

describe('Component Tests', () => {
  describe('StatusAttachments Management Update Component', () => {
    let comp: StatusAttachmentsUpdateComponent;
    let fixture: ComponentFixture<StatusAttachmentsUpdateComponent>;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [StatusAttachmentsUpdateComponent],
        providers: [FormBuilder, ActivatedRoute],
      })
        .overrideTemplate(StatusAttachmentsUpdateComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(StatusAttachmentsUpdateComponent);
