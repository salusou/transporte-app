...
import com.genesisoft.transporte.service.EmployeesQueryService;
import com.genesisoft.transporte.service.EmployeesService;
...
/**
 * REST controller for managing {@link com.genesisoft.transporte.domain.Employees}.
 */
@RestController
@RequestMapping("/api")
public class EmployeesResource {
    ...
    public ResponseEntity<EmployeesDTO> updateEmployees(
        ...
        @Valid @RequestBody EmployeesDTO employeesDTO
    ...
    public ResponseEntity<EmployeesDTO> partialUpdateEmployees(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody EmployeesDTO employeesDTO
    ) throws URISyntaxException {
    ...
    public ResponseEntity<List<EmployeesDTO>> getAllEmployees(EmployeesCriteria criteria, Pageable pageable) {
