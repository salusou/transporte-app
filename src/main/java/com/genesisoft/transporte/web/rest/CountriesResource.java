...
import com.genesisoft.transporte.service.CountriesQueryService;
import com.genesisoft.transporte.service.CountriesService;
...
/**
 * REST controller for managing {@link com.genesisoft.transporte.domain.Countries}.
 */
@RestController
@RequestMapping("/api")
public class CountriesResource {
    ...
    public ResponseEntity<CountriesDTO> updateCountries(
        ...
        @Valid @RequestBody CountriesDTO countriesDTO
    ...
    public ResponseEntity<CountriesDTO> partialUpdateCountries(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody CountriesDTO countriesDTO
    ) throws URISyntaxException {
    ...
    public ResponseEntity<List<CountriesDTO>> getAllCountries(CountriesCriteria criteria, Pageable pageable) {
