...
```
$ docker image tag transporte genesisoft/transporte
$ docker push genesisoft/transporte
```
...
```
$ kubectl get svc transporte -n transporte
```
...
```
$ kubectl scale deployment <app-name> --replicas <replica-count> -n transporte
```
...
```
$ kubectl set image deployment/<app-name>-app <app-name>=<new-image>  -n transporte
```
...
```
$ kubectl expose service jhipster-registry --type=NodePort --name=exposed-registry -n transporte
```

and explore the details using

```
$ kubectl get svc exposed-registry -n transporte
```

For scaling the JHipster registry, use

```
$ kubectl scale statefulset jhipster-registry --replicas 3 -n transporte
```
